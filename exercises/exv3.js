...
function islassOne(course) {
    return course.Location === "Classroom 1";
}

let classOne = courses.filter (isClassOne);
console.log("The classes that meet in Classroom 1 are: ", classOne)

// arrow function:
let classOne = courses.filter (course => course.Location === "Classroom 1");
console.log("The classes that meet in Classroom 1 are: ", classOne)